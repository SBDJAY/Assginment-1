...
def choosePillar():
    pillar = ""
    while pillar != "Darkness" and pillar != "Tower" and pillar != "Earth" and pillar != "Pyramid" and pillar != "Fleet" and pillar != "Travaler": # input validation
        pillar = input("Choose a Pillar to stand on(Darkness   Tower   Earth   Pyramid   Fleet   Travaler): ")

    return pillar

correctPillar = ['Darkness', "Tower", "Earth", "Pyramid", "Fleet", "Travaler"]
...
def checkThe_Obelisk(chosenPillar):
    print("\033[1;36;40m\n")  #Ghost Dialogue
    print("Well Titan it was a pretty difficult task before hand but you can get thorugh this all you have to do is stand on the right pillar...")

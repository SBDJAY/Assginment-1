...
def choosePillar():
    pillar = ""
    while pillar != "Darkness" and pillar != "Tower" and pillar != "Earth" and pillar != "Pyramid": # input validation
        pillar = input("Choose a Pillar to stand on (Darkness   Tower   Earth   Pyramid): ")

    return pillar

correctPillar = ['Darkness', "Tower", "Earth", "Pyramid",]
...
def checkThe_Obelisk(chosenPillar):
    print("\033[1;36;40m\n")  #Ghost Dialogue
    print("Well Hunter the first time was not too bad, but I know you can do it this time, your a Hunter of course go it at it offer the right pillar...")
